...
# Form implementation generated from reading ui file 'C:\Users\Valen\Documents\PROJECTS\.pipeline\all\ui\cioxo_createThumbnail.ui'
#
...
class Ui_cioxo_createTumbnail(object):
    def setupUi(self, cioxo_createTumbnail):
        cioxo_createTumbnail.setObjectName("cioxo_createTumbnail")
        cioxo_createTumbnail.resize(474, 195)
        cioxo_createTumbnail.setMinimumSize(QtCore.QSize(0, 0))
        cioxo_createTumbnail.setMaximumSize(QtCore.QSize(16777215, 16777215))
        cioxo_createTumbnail.setStyleSheet("background-color: rgb(27, 27, 27);")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(cioxo_createTumbnail)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.frame_all = QtWidgets.QFrame(cioxo_createTumbnail)
        ...
        self.label_createThumbnail = QtWidgets.QLabel(self.frame_title)
        font = QtGui.QFont()
        font.setFamily("Source Sans Pro")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.label_createThumbnail.setFont(font)
        self.label_createThumbnail.setStyleSheet("color:white;")
        self.label_createThumbnail.setAlignment(QtCore.Qt.AlignCenter)
        self.label_createThumbnail.setObjectName("label_createThumbnail")
        self.horizontalLayout_6.addWidget(self.label_createThumbnail)
        ...
        self.label_file.setMaximumSize(QtCore.QSize(16777215, 21))
        font = QtGui.QFont()
...
"}")
        ...
        self.frame_informations.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"}")
        ...
        self.retranslateUi(cioxo_createTumbnail)
        QtCore.QMetaObject.connectSlotsByName(cioxo_createTumbnail)

    def retranslateUi(self, cioxo_createTumbnail):
        _translate = QtCore.QCoreApplication.translate
        cioxo_createTumbnail.setWindowTitle(_translate("cioxo_createTumbnail", "Dialog"))
        self.label_createThumbnail.setText(_translate("cioxo_createTumbnail", "Create Thumbnail"))
        self.label_file.setText(_translate("cioxo_createTumbnail", "..."))
        self.button_browse.setText(_translate("cioxo_createTumbnail", "Browse"))
        self.label_informations.setText(_translate("cioxo_createTumbnail", ">>> Terminal - Select an image "))
        self.button_ok.setText(_translate("cioxo_createTumbnail", "OK"))
        self.button_cancel.setText(_translate("cioxo_createTumbnail", "Cancel"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    cioxo_createTumbnail = QtWidgets.QDialog()
    ui = Ui_cioxo_createTumbnail()
    ui.setupUi(cioxo_createTumbnail)
    cioxo_createTumbnail.show()
    sys.exit(app.exec_())
