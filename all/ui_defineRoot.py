...
# Form implementation generated from reading ui file 'C:\Users\Valen\Documents\PROJECTS\.pipeline\all\ui\defineRoot.ui'
#
...
class Ui_DefineRoot(object):
    def setupUi(self, DefineRoot):
        DefineRoot.setObjectName("DefineRoot")
        DefineRoot.resize(478, 199)
        DefineRoot.setStyleSheet("background-color: rgb(27, 27, 27);")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(DefineRoot)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.frameAll = QtWidgets.QFrame(DefineRoot)
        ...
        self.labelFile.setMaximumSize(QtCore.QSize(375, 21))
        font = QtGui.QFont()
...
"}")
        ...
        self.retranslateUi(DefineRoot)
        QtCore.QMetaObject.connectSlotsByName(DefineRoot)

    def retranslateUi(self, DefineRoot):
        _translate = QtCore.QCoreApplication.translate
        DefineRoot.setWindowTitle(_translate("DefineRoot", "Dialog"))
        self.labelCreateProject.setText(_translate("DefineRoot", "Define root"))
        self.labelFile.setText(_translate("DefineRoot", "..."))
        self.buttonBrowse.setText(_translate("DefineRoot", "Browse"))
        self.labelInformations.setText(_translate("DefineRoot", ">>> Terminal - Select root folder - Usually a folder called \"PROJECTS\" which will contain the projects"))
        self.buttonOk.setText(_translate("DefineRoot", "OK"))
        self.buttonCancel.setText(_translate("DefineRoot", "Cancel"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    DefineRoot = QtWidgets.QDialog()
    ui = Ui_DefineRoot()
    ui.setupUi(DefineRoot)
    DefineRoot.show()
    sys.exit(app.exec_())
